...
// Motor da esquerda
const int ena_esquerda = 3; // Pino ENABLE do motor esquerdo (controle da velocidade)
const int in_3 = 4;         // Entrada 3 do driver do motor esquerdo
const int in_4 = 5;         // Entrada 4 do driver do motor esquerdo

// Motor da direita
const int ena_direita = 6; // Pino ENABLE do motor direito (controle da velocidade)
...
void loop() {
    ...
    while (SerialBT.available() > 0) {
        char comando = SerialBT.read(); // Lê um caractere enviado pelo celular
